...
function driftCloud(e) {
  ...
  cloudOne.style.transform = `translate(${
    clientX - halfCloudEncapsulatorWidth
  }px, ${clientY - halfCloudEncapsulatorHeight}px)`;
}
...
function toggleTheme() {
  if (themeSwitch.checked) {
    ...
    root.style.setProperty(
      '--color-text-primary',
      'var(--color-text-primary-night)'
    );
    root.style.setProperty('--background', 'var(--background-night)');
    root.style.setProperty(
      '--theme-switcher-background',
      'var(--theme-switcher-background-night)'
    );
    root.style.setProperty(
      '--theme-switcher-box-shadow',
      'var(--theme-switcher-box-shadow-night)'
    );

    root.style.setProperty(
      '--nav-button-color',
      'var(--nav-button-color-night)'
    );
    root.style.setProperty(
      '--nav-button-shadow',
      'var(--nav-button-shadow-night)'
    );
    root.style.setProperty('--nav-link-color', 'var(--nav-link-color-night');
    root.style.setProperty(
      '--nav-link-background-mobile',
      'var(--nav-link-background-mobile-night'
    );

    root.style.setProperty('--footer-text', 'var(--footer-text-night)');
    root.style.setProperty(
      '--footer-background',
      'var(--footer-background-night)'
    );

    root.style.setProperty(
      '--shop-background-item',
      'var(--shop-background-item-night)'
    );
    root.style.setProperty(
      '--shop-item-background',
      'var(--shop-item-background-night)'
    );
    root.style.setProperty(
      '--shop-item-box-shadow',
      'var(--shop-item-box-shadow-night)'
    );
    root.style.setProperty(
      '--shop-item-box-shadow-hover',
      'var(--shop-item-box-shadow-hover-night)'
    );
    root.style.setProperty('--shop-item-title', 'var(--shop-item-title-night)');
    root.style.setProperty(
      '--shop-radio-background',
      'var(--shop-radio-background-night)'
    );
    root.style.setProperty(
      '--shop-radio-shadow',
      'var(--shop-radio-shadow-night)'
    );
    root.style.setProperty(
      '--shop-radio-shadow-one',
      'var(--shop-radio-shadow-one-night)'
    );
    root.style.setProperty(
      '--shop-radio-shadow-two',
      'var(--shop-radio-shadow-two-night)'
    );

    root.style.setProperty(
      '--about-main-shadow',
      ' var(--about-main-shadow-night)'
    );
  } else if (!themeSwitch.checked) {
    // * DAY MODE
    ...
    root.style.setProperty(
      '--color-text-primary',
      'var(--color-text-primary-day)'
    );
    root.style.setProperty('--background', 'var(--background-day)');
    root.style.setProperty(
      '--theme-switcher-background',
      'var(--theme-switcher-background-day)'
    );
    root.style.setProperty(
      '--theme-switcher-box-shadow',
      'var(--theme-switcher-box-shadow-day)'
    );

    root.style.setProperty('--nav-button-color', 'var(--nav-button-color-day)');
    root.style.setProperty(
      '--nav-button-shadow',
      'var(--nav-button-shadow-day)'
    );
    root.style.setProperty('--nav-link-color', 'var(--nav-link-color-day');
    root.style.setProperty(
      '--nav-link-background-mobile',
      'var(--nav-link-background-mobile-day'
    );

    root.style.setProperty('--footer-text', 'var(--footer-text-day)');
    root.style.setProperty(
      '--footer-background',
      'var(--footer-background-day)'
    );

    root.style.setProperty(
      '--shop-background-item',
      'var(--shop-background-item-day)'
    );
    root.style.setProperty(
      '--shop-item-background',
      'var(--shop-item-background-day)'
    );
    root.style.setProperty(
      '--shop-item-box-shadow',
      'var(--shop-item-box-shadow-day)'
    );
    root.style.setProperty(
      '--shop-item-box-shadow-hover',
      'var(--shop-item-box-shadow-hover-day)'
    );
    root.style.setProperty('--shop-item-title', 'var(--shop-item-title-day)');
    root.style.setProperty(
      '--shop-radio-background',
      'var(--shop-radio-background-day)'
    );
    root.style.setProperty(
      '--shop-radio-shadow',
      'var(--shop-radio-shadow-day)'
    );
    root.style.setProperty(
      '--shop-radio-shadow-one',
      'var(--shop-radio-shadow-one-day)'
    );
    root.style.setProperty(
      '--shop-radio-shadow-two',
      'var(--shop-radio-shadow-two-day)'
    );

    root.style.setProperty(
      '--about-main-shadow',
      ' var(--about-main-shadow-day)'
    );
  }
